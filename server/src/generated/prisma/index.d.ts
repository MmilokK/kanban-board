...
export namespace Prisma {
  ...
  */
  ...
  export type NotificationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      'id' | 'userId' | 'type' | 'title' | 'message' | 'boardId' | 'readAt' | 'createdAt',
      ExtArgs['result']['notification']
    >;
  ...
  interface NotificationFieldRefs {
    ...
    readonly boardId: FieldRef<'Notification', 'String'>;
  ...
  export type NotificationWhereInput = {
    ...
    boardId?: StringNullableFilter<'Notification'> | string | null;
  ...
  export type NotificationScalarWhereWithAggregatesInput = {
    ...
    boardId?: StringNullableWithAggregatesFilter<'Notification'> | string | null;
